package com.sahachko.consoledbproject.view;

import java.util.List;
import java.util.Scanner;

import com.sahachko.consoledbproject.controller.RegionController;
...
public class RegionView {
	...
	public void startConsole() {
		...
		while(true) {
			...
			System.out.println("Do you want to continue with region? (\"yes\"\\\"no\")");
